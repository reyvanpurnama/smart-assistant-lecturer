...
## 🎯 PANDUAN ALUR DRAFT EKSEMPLAR & STRUKTUR SLIDE PRESENTASI (12 SLIDE UTAMA)

Dokumen ini disusun berdasarkan analisis mendalam terhadap draf eksemplar final Anda (`revisi reyvan 03 agustus`). Gunakan panduan slide ini untuk membuat file PowerPoint (PPT/Canva) dan gunakan script bicaranya saat presentasi di depan dosen penguji.
...
* **Sub-Judul:** Arsitektur Provider-Agnostic Middleware & 3-Point Partial Credit Rubric
* **Nama & NIM:** M Reyvan Purnama (220102043)
* **Program Studi:** Teknik Informatika, Fakultas Sains dan Teknologi, Universitas Muhammadiyah Bandung (2026)
* **Dosen Pembimbing:** Ibu Aila Gema Safitri, S.T., M.T. & Ibu Ririn Suharsih, S.Pd., M.T.
...
> *"Dari latar belakang tersebut, rumusan masalah penelitian ini berfokus pada dua hal: Pertama, bagaimana merancang middleware untuk mengendalikan LLM agar bebas halusinasi dan ramah rubrik dosen. Kedua, bagaimana mengukur tingkat keselarasan penilaian AI dibanding penilaian manual dosen menggunakan metrik Kendall's Tau-b dan MAE."*
...
🎙️ **Script Omongan Bicara Reyvan (45 detik):**
> *"Metode penelitian mengadopsi Prototyping Model menggunakan dataset retrospektif 33 mahasiswa. Pengujian dilakukan melalui dua iterasi utama: Iterasi 1 sebagai baseline menggunakan penilaian biner kaku (0/100), dan Iterasi 2 sebagai penyempurnaan menggunakan skema 3-Point Partial Credit (0, 50, 100) yang dipadukan dengan Chain-of-Thought reasoning."*
...
🎙️ **Script Omongan Bicara Reyvan (45 detik):**
> *"Komputasi statistik dilakukan secara tepat mengoreksi faktor nilai kembar (ties). Dari total 528 kombinasi pasangan, didapatkan 379 pasangan concordant (sejalan) yang menghasilkan nilai Kendall's Tau-b sebesar 0.7724. Sedangkan total akumulasi selisih mutlak 33 mahasiswa sebesar 179.85 poin menghasilkan nilai MAE akhir sebesar 5.45 poin."*
...
* **Mitigasi Halusinasi (Knowledge Grounding):** 
  * 0 Kasus halusinasi di luar skema database `universitas` pada 33 sampel pengujian (Ji et al., 2023; Claes, 2025).
* **Transparansi Evaluasi (Chain-of-Thought):**
  * LLM mengekstrak log `global_reasoning` sebelum mengembalikan skor JSON, mencegah *hasty grading* (Stahl et al., 2024; Wang et al., 2022).

🎙️ **Script Omongan Bicara Reyvan (45 detik):**
> *"Secara empiris, penelitian ini mengonfirmasi bahwa Knowledge Grounding pada middleware berhasil memitigasi halusinasi total, di mana 0 kasus keluaran di luar naskah soal ditemukan. Selain itu, Chain-of-Thought reasoning memberikan transparansi bagi dosen untuk memverifikasi alasan logis di balik setiap pemberian nilai AI."*
...
🎙️ **Script Omongan Bicara Reyvan (15 detik):**
> *"Sekian presentasi dari saya. Terima kasih atas perhatian Bapak dan Ibu Dosen. Saya siap untuk menerima pertanyaan dan arahan lebih lanjut."*

---

## 🛡️ TANDATANGAN & TANGKISAN DEFENSIF SAAT TANYA JAWAB (Q&A)

Apabila Dosen Penguji menanyakan draf eksemplar Anda saat sidang:
1. **Penguji:** *"Mana tabel komparasi biner lengkap di naskah kamu?"*
