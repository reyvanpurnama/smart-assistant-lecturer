...
| **2. Modular Chain-of-Thought (CoT) Prompting** | **Stahl et al. (2024)**<br><br>**Agarwal et al. (2025)** | • CoT (*Feedback -> Scoring*) menghasilkan nilai & umpan balik paling transparan.<br>• Model Card **GPT-OSS-120B**: Model *open-weight reasoning* via *Harmony Format*. | • AI wajib mengurai log penalaran (CoT) sebelum merilis nilai akhir.<br>• Kanal `System` vs `User` untuk memblokir *prompt injection*. |
...
| **4. Knowledge Grounding Module** | **Ji et al. (2023)** | • Taksonomi **Halusinasi Intrinsik** & **Halusinasi Ekstrinsik** akibat *Parametric Bias*. | • Modul pengikat konteks (modul, rubrik, & kunci) membasmi halusinasi. |
