...
import { getModelDisplayName } from "@/lib/grading/model-policy";
                ...
                {isLoading ? (
                  ...
                  assignments.map((item) => (
                    ...
                    >
                      ...
                      <div className="mt-2 text-[9px] text-muted-text font-mono">Model: {getModelDisplayName(item.model)}</div>
                    </div>
                  ))
                )}
              </div>
