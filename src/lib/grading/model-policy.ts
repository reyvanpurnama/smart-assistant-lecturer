...
export function getModelDisplayName(modelId: string): string {
  ...
  if (id === "openai/gpt-oss-120b") return "Model Utama (Llama 3.3 70B)";
  if (id === "openai/gpt-oss-20b") return "Model Cepat (Llama 3 8B)";
  if (id === "openai/gpt-oss-safeguard-20b") return "Model Pengaman (Llama 3 8B-Lite)";
  if (id === "llama-3.3-70b-versatile") return "Model Utama (Llama 3.3 70B)";
  return modelId;
}
